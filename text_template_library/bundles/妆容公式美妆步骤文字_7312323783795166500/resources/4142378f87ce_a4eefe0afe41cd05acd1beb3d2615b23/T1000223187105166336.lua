...
local T1000223187105166336 = T1000223187105166336 or {}
T1000223187105166336.__index = T1000223187105166336
function T1000223187105166336.new(construct, ...)
    local self = setmetatable({}, T1000223187105166336)
    self.duration = 1.0
    self.count = 0
    if construct and T1000223187105166336.constructor then T1000223187105166336.constructor(self, ...) end
    return self
end

function T1000223187105166336:constructor()

end

function T1000223187105166336:onStart(comp) 
...
function T1000223187105166336:animate()
    return {
        -- ['playSpeed'] = 30,
        ["anchor"] = {0, 0},
        ["pivot"] = {0, 0},
...
function T1000223187105166336:animateChar(char)
	return {
		['mode'] = 0,
		['duration'] = .8,
		['anchor'] = {0, 0},
...
-- local time = 0
-- function T1000223187105166336:onUpdate(comp, deltaTime)
-- 	time = time + deltaTime
...
function T1000223187105166336:seek(time)
	if self.first then
...
function T1000223187105166336:setDuration(duration)
   self.duration = duration
end


function T1000223187105166336:resetData( ... )
	if self.text ~= nil then
    	local chars = self.text.chars 
...
function T1000223187105166336:clear()
	self:resetData()
	self.text.renderToRT = false

end

function T1000223187105166336:onEnter()
	self.first = true
end

function T1000223187105166336:onLeave()
	self:resetData()
	self.text.renderToRT = false
	self.first = true
end
...
exports.T1000223187105166336 = T1000223187105166336
return exports

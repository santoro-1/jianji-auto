...
class Widget2D extends Widget {
  ...
  updateWidgetAnimation(startTime, duration, loopDuration, animType) {
    ...
    if (anim) {
      ...
      if (0 !== duration) {
        ...
        anim.animationEndTime = anim.animationStartTime + duration;
      }

      if (0 !== loopDuration) {
        anim.animationLoopDuration = loopDuration;
      }
    }
  }
  ...
  addWidgetAnimation(path, resourceID, scriptType, startTime, duration, loopDuration, animType) {
    ...
    anim.animationStartTime = startTime;
    anim.animationEndTime = startTime + duration;
    anim.animationDuration = duration;
    anim.animationLoopDuration = loopDuration;
  ...
  get parameters() {
    if (this.textComp) {
      ...
      const textParam = {
        ...
        lineSpacing: this.textComp.typeSettingParam.letterSpacing,

...
local function animate(char, total)
	return {
		...
		['animations'] = {
			...
			['scale'] = {
				{0, .26, {0, 0, 0}, {1, 1, 1}, {0.25, 0.00, 0.99, 1.00}}
			},
			['rotate.x'] = {
			},
			['rotate.y'] = {
			...
			['rotate.z'] = {
			{0, .26, 20, -20, {0.00, 0.00, 0.46, 1.00}},
			{.26, .52, -20, 0, {0.17, 0.00, 0.46, 1.00}}
			},
			['rotate'] = {
			...
			['translate.x'] = {
				{0, .52, -char.width, char.width / 2, {0.14, 0.00, 0.66, 1.00}},
				{.52, 1, char.width / 2, 0, {0.21, 0.00, 0.77, 1.00}}
			},
			['translate.y'] = {
			},
			['translate.z'] = {

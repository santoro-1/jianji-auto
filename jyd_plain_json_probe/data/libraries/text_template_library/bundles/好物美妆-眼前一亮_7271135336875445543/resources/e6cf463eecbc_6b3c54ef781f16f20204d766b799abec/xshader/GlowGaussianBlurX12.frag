...
void main()
{
    ...
    vec2 dir = gauss_stron2*vec2(cos(theta), sin(theta)) / vec2(720.,720.*u_ScreenParams.y/u_ScreenParams.x);
    vec4 color = gaussianBlur(inputTexture4, uv0, dir, u_Strength);
    gl_FragColor = color;
}

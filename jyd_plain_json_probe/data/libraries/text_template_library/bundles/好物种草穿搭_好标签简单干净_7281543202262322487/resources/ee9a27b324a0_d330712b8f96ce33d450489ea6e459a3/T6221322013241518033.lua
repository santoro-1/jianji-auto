...
local T6221322013241518033 = T6221322013241518033 or {}
T6221322013241518033.__index = T6221322013241518033
function T6221322013241518033.new(construct, ...)
    local self = setmetatable({}, T6221322013241518033)
    self.duration = 1.0
    self.count = 0
    if construct and T6221322013241518033.constructor then T6221322013241518033.constructor(self, ...) end
    return self
end

function T6221322013241518033:constructor()

end

function T6221322013241518033:onStart(comp) 
...
function T6221322013241518033:animate()
    return {
        -- ['playSpeed'] = 30,
        ["anchor"] = {0, 0},
        ["pivot"] = {0, 0},
...
function T6221322013241518033:animateChar(char)
	return {
		['mode'] = 0,
		['duration'] = .8,
		['anchor'] = {0, 0},
...
-- local time = 0
-- function T6221322013241518033:onUpdate(comp, deltaTime)
-- 	-- time = time + deltaTime
...
function T6221322013241518033:seek(time)
	if self.first then
...
function T6221322013241518033:setDuration(duration)
   self.duration = duration
end

function T6221322013241518033:resetData( ... )
	if self.text ~= nil then
    	local chars = self.text.chars 
...
function T6221322013241518033:clear()
	self:resetData()
	self.text.renderToRT = false

end

function T6221322013241518033:onEnter()
	self.first = true
end

function T6221322013241518033:onLeave()
	self:resetData()
	self.text.renderToRT = false
	self.first = true
end
...
exports.T6221322013241518033 = T6221322013241518033
return exports
